// define the Game class to represent the game's data (properties) and behaviors (methods).
class Game {
  constructor() {
  ...
  updateScore() {
    ...
    scoreDisplayElement.textContent = `${this.score}`;
  }

  // update the screen
  updateLives() {
    const livesDisplayElement = document.getElementById("lives");
    livesDisplayElement.textContent = `${this.lives}`;
  }
