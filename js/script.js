window.onload = function () {
  ...
  function handleKeydown(event) {
    ...
    if (possibleKeystrokes.includes(key)) {
      ...
      // in this case, it's scroll-up / scroll-down / scroll-left / scroll-left / scroll-right in the browser window
  ...
  // Funtion that handles keyup (releasing the key) event
  ...
  // Associate the handlekeydown function with and Event Listener
